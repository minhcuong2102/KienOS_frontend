...
import SaleNonPTContractTable from './SaleNonPTContractTable';

const SaleNonPTContract = (): ReactElement => {
  ...
  return (
    <Paper sx={{ p: { xs: 4, sm: 8 }, height: 1 }}>
      ...
      <Box width={1} flexGrow={1} minHeight={325}>
        <SaleNonPTContractTable searchText={search} />
      </Box>
    </Paper>
  );
};

export default SaleNonPTContract;
