...
import NonPTServiceCustomerTable from './NonPTServiceCustomerTable';
import React from 'react';

const NonPTServiceCustomers = (): ReactElement => {
  ...
  return (
    <Paper sx={{ p: { xs: 4, sm: 8 }, height: 1 }}>
      ...
      <Box width={1} flexGrow={1} minHeight={325}>
        <NonPTServiceCustomerTable searchText={search} />
      </Box>
    </Paper>
  );
};

export default NonPTServiceCustomers;
